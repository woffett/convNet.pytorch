...
def cmds_1_16_20_train_base_models():
    ...
    cmd_format_str = ('qsub -V -b y -wd /proj/distill/wd /proj/distill/git/convNet.pytorch/ml_env.sh '
                          '\\"python /proj/distill/git/convNet.pytorch/main.py '
    ...
    with open(filename,'w') as f:
        for i,model in enumerate(models):
            ...
            f.write(cmd_format_str.format(results_dir, data_dir, run_name, dataset, model, model_config,
